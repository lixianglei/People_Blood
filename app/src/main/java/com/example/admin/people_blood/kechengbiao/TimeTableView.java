package com.example.admin.people_blood.kechengbiao;
...
public class TimeTableView extends LinearLayout {
    ...
    //最大节数
    public final static int MAXNUM = 3;
    //显示到星期几
    ...
    private View getWeekTransverseLine() {
     //自定义的横的分割线。设置它的高度为2
       TextView   mWeekLine=new TextView(getContext());
        ...
        mWeekLine.setHeight(2);
        mWeekLine.setWidth(ViewGroup.LayoutParams.MATCH_PARENT);
        return mWeekLine;
    }
